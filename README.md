# Structure-Based-Genetic-Programming-for-Regression
 implementing structure-based genetic programming to predict the electricity load for a specific time on a particular day given the data for the n previous days at the same time or alternatively the m previous values can be used
